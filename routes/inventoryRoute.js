...
router.get("/", utilities.checkAuthorized, utilities.handleErrors(invController.buildManagement))

// build the add classification page
router.get("/add-classification", utilities.checkAuthorized, utilities.handleErrors(invController.buildAddClassification))

// build the add inventory page
router.get("/add-inventory", utilities.checkAuthorized, utilities.handleErrors(invController.buildAddInventory))

// build the inventory list
router.get("/getInventory/:classification_id", utilities.handleErrors(invController.getInventoryJSON))

// build the edit inventory page
router.get("/edit/:inv_id", utilities.checkAuthorized, utilities.handleErrors(invController.buildEditInventory))
...
// update inventory
router.post("/edit-inventory", invValidate.inventoryRules(),invValidate.checkEditInventoryData,utilities.handleErrors(invController.editInventory))
